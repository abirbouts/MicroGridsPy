...
from microgridspy.model.constraints.transformation_constraints import add_inverter_minimum_size_constraints
...
class Model:
    ...
    def _add_constraints(self) -> None:
        ...
        add_inverter_minimum_size_constraints(self.model, self.settings, self.sets, self.parameters, self.variables, self.has_battery, self.has_generator, self.has_grid_connection)
